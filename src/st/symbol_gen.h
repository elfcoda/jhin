...
class SymbolGen
{
    ...
    public:
        ...
        std::shared_ptr<symbolGenRtn> genSymbolTable(ast::pASTNode pRoot)
        {
            ...
            JHIN_ASSERT_BOOL(text != "" && AST_DEFAULT_TEXT != "");
            ...
            if (comm::isASTSymbolLeaf(astSymId)) {
                ...
                if (text == AST_DEFAULT_TEXT) {
                    ...
                    JHIN_ASSERT_STR("undefined op");
                }
            } else {
                JHIN_ASSERT_STR("symbol should be leaf or non-leaf");
            }
    ...
    private:
        ...
        pTypeTree getFnLastType(pTypeTree pTT)
        {
            ...
            JHIN_ASSERT_BOOL(childrenNum >= 2);
    ...
    private:
                ...
                case ast::AST_LEAF_RE_ID:
                    {
                        ...
                        if (symbol == nullptr) {
                            ...
                            if (isFn && EType != E_ID_TYPE_FN_TYPE) JHIN_ASSERT_STR("symbol not function type.");
        ...
        {
            JHIN_ASSERT_BOOL(rnt1 != nullptr && rnt2 != nullptr);
        ...
        std::shared_ptr<symbolGenRtn> handleFn(ast::pASTNode pRoot)
        {
            ...
            for (unsigned idx = 1; idx < pRoot->size(); idx++) {
                auto pSymGenRtn = genSymbolTable(pRoot->getChild(idx));
                JHIN_ASSERT_BOOL(pSymGenRtn != nullptr);
                ...
                if (notationStr == "FnArg") {
                    ...
                    if (getSymbolType(pTp) == E_ID_TYPE_TRIVIAL_TYPE) {
                        ...
                        JHIN_ASSERT_STR("can not return 'Type'.");
                    } else {
                        JHIN_ASSERT_STR("return type error.");
                    }
            ...
            JHIN_ASSERT_BOOL(isTypeEqual(getFnLastType(fnType), fnBodyType));
